                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            <div class="form-group">
                                <!-- set_value itu untuk ketika kita salah atau error ketika mengisi form itu tidak akan menghapus semua yang sudah di isi dalam folder -->
                                <input type="text" class="form-control form-control-user" id="name" placeholder="Full Name" name="name" value="<?= set_value('name'); ?>">
                                <!-- untuk menambahkan validation eror di bawha input di dalam tag small untuk tulisan kecil dan class text-danger itu untuk text yang berwarna merah-->
